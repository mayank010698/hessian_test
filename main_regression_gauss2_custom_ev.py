...
dataset     = 'Gauss2'
meta = "Sanity check using a single layer regression problem, adding custom ev at 2000 "
epochs      = 50
...
config_dict["meta"] = "Sanity check using a single layer regression problem, adding custom ev at 2000 "
