...
config_dict["meta"] = "Using resnet18smooth with MSE loss "
...
for epoch in range(epochs):
    ...
    if((epoch)%5==0):
        ...
        predictor_hessian_comp = hessian(model, loss_fn,  data=(traj_ip, traj_labels),wrt_loss=False,output_index = 0)
